        ...
        <>
            <div className="absolute left-[310px] top-[214px] w-[830px] flex flex-col items-start justify-start gap-[20px]">
                ...
                <div className="self-stretch h-[50px] shrink-0 flex flex-row items-center justify-between">
                    <button onClick={generalWritePage} className="flex flex-row items-center justify-center gap-[5px] p-[15px] bg-[#0090f9] rounded-[10px]">
                ...
                <div className="self-stretch flex flex-col items-start justify-start gap-[5px]">
                    <div className="self-stretch flex flex-col items-start justify-start gap-[5px]">
                        ...
                        <div className="self-stretch flex flex-row items-center justify-start gap-[10px]">
                            <button onClick={generalDetailPage} className="flex-1 text-[16px] leading-[24px] font-['Roboto'] text-[#000] text-left">글 제목</button>
