        ...
        <div className="absolute left-[487px] top-[146px] w-[466px] flex flex-col items-start justify-start gap-[31px]">
            ...
            <div className="self-stretch flex flex-col items-start justify-start gap-[30px]">
                <div className="self-stretch flex flex-col items-start justify-start gap-[5px]">
                    <div className="self-stretch text-[16px] leading-[25px] font-['Roboto'] text-[#000]">현재 비밀번호</div>
                    ...
                    <div className="self-stretch text-[16px] leading-[25px] font-['Roboto'] text-[#f00]">현재 비밀번호가 일치하지 않습니다.</div>
                </div>
                <div className="self-stretch flex flex-col items-start justify-start gap-[5px]">
...
export default ChangePasswordForMyPage