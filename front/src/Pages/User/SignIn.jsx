    ...
    return (<div className="relative w-[1440px] h-[1024px] bg-[#fff] overflow-hidden">
        <div className="absolute left-[487px] top-[146px] w-[466px] flex flex-col items-start justify-start gap-[31px]">
            ...
            {/* 
                로그인 폼
            */}
            <form action='/api/user/select' method='get' id='signin' className="self-stretch flex flex-col items-start justify-start gap-[30px]">
                <div className="self-stretch flex flex-col items-start justify-start gap-[5px]">
                    ...
                    <div className="self-stretch h-[44px] shrink-0 flex flex-row items-center justify-start p-[10px] border-[1px] border-solid border-[#00000080] rounded-[10px]">
                        <input placeholder='이메일을 입력해 주세요.' type='email' name='uUserEmail' className="flex-1 text-[16px] leading-[25px] font-['Roboto'] text-[#000] outline-none"></input>
                    </div>
                ...
                <div className="self-stretch flex flex-col items-start justify-start gap-[5px]">
                    ...
                    <div className="self-stretch h-[44px] shrink-0 flex flex-row items-center justify-start p-[10px] border-[1px] border-solid border-[#00000080] rounded-[10px]">
                        <input placeholder='비밀번호를 입력해주세요.' type='password' name='uPassword' className="flex-1 text-[16px] leading-[25px] font-['Roboto'] text-[#000] outline-none"></input>
                    </div>
                    <div hidden className="self-stretch text-[16px] leading-[25px] font-['Roboto'] text-[#f00]">최소 6자리 이상이어야 합니다.</div>
                </div>
            </form>
            {/* 
                버튼
            */}
            <div className="self-stretch h-[146px] shrink-0 flex flex-col items-start justify-start gap-[13px]">
                <button type='submit' form='signin' className="self-stretch flex flex-row items-center justify-center p-[10px] bg-[#0090f9] rounded-[10px]">
