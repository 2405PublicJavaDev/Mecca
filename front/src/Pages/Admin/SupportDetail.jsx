        ...
        <>
            <div className="absolute left-[441px] top-[129px] w-[557px] flex flex-col items-start justify-start gap-[20px]">
                <div className="self-stretch flex flex-row items-center justify-start gap-[25px]">
                    ...
                    <div className="text-[19px] leading-[40px] font-['Roboto'] font-semibold text-[#00000080] whitespace-nowrap">문의</div>
                    <div className="flex-1 h-0 border-[1px] border-solid border-[#00000080]"></div>
                </div>
                ...
                <div className="self-stretch flex flex-row items-center justify-center gap-[20px]">
                    <button onClick={responseWritePage} className="flex flex-row items-center justify-center py-[12px] px-[24px] bg-[#0090f9] rounded-[10px]">
                        <div className="text-[20px] leading-[20px] font-['Roboto'] font-bold text-[#fff] whitespace-nowrap">답변</div>
                    </button>
                </div>
            </div>
        </>
